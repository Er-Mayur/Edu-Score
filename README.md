...
### Setup Edu-Score:
- Clone this repository: `git clone https://github.com/Er-Mayur/Edu-Score.git`
- Open terminal in the same directory, where repo was cloned.
- Activate virtual environment.
- Change path into cloned repository directory: `cd Edu-Score`
- Change path into Django project: `cd Edu-Score`
